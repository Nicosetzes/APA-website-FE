...
const Statistics = () => {
	...
	if (stats) {
		...
		return (
			<>
				<div>Statistics</div>
				<div className="chart__container" style={{ width: "100%", display: "flex", flexWrap: "wrap", justifyContent: "space-evenly" }}>
					<div style={{ width: "400px", height: "300px", display: "flex" }}>
						<BarChart data={dataForBarChart} options={optionsForBarChart} className="hola" />
					</div>
					<div style={{ width: "400px", height: "300px", margin: "1rem 0" }}>
						<DoughnutChart data={dataForDoughnutChart} options={optionsForDoughnutChart} />
					</div>
				</div>
				{/* <PieChart /> */}
