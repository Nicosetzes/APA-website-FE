        ...
        <div className="playoff__first-round">
          ...
          <div className="match">
            ...
            <div className="match-team">
              ...
              <span className="match-team-name">
                {rankedTeams[11].team} (
                {rankedTeams[11].player[0].toUpperCase()}
          ...
          <div className="match">
            ...
            <div className="match-team">
              ...
              <span className="match-team-name">
                {rankedTeams[12].team} (
                {rankedTeams[12].player[0].toUpperCase()}
        ...
        <div className="playoff__first-round">
          <div className="match">
            ...
            <div className="match-team">
              ...
              <span className="match-team-name">
                {rankedTeams[10].team} (
                {rankedTeams[10].player[0].toUpperCase()}
                {rankedTeams[10].player[1].toUpperCase()})
              </span>
            </div>
          </div>
          <div className="match">
            ...
            <div className="match-team">
              ...
              <span className="match-team-name">
                {rankedTeams[13].team} (
                {rankedTeams[13].player[0].toUpperCase()}
          ...
          <div className="match">
            <div className="match-team">
              ...
              <img className="match-team-logo" src={rankedTeams[1].logo}></img>
              <span className="match-team-name">
                {rankedTeams[1].team} ({rankedTeams[1].player[0].toUpperCase()}
                {rankedTeams[1].player[1].toUpperCase()})
              </span>
            </div>
            <div className="match-team">
              ...
              <span className="match-team-name">
                {rankedTeams[14].team} (
                {rankedTeams[14].player[0].toUpperCase()}
